...
public:
  ...
  int TotalSchedule; // The number of available profiles schedulesin "schedule
                     // list"- starts from 1
  int currentSchedule; // this holds the current row from the "schedule list"-
                       // starts from 0
  ...
  void clearScheduleDetails(); // function: when clear (schedule details)
                               // pushbutton pressed
  bool saveScheduleFile(); // function to save the schedule-file
  QString scheduleText(QString, int, int, int, int, int,
                       bool); // returns the text displayed at the schedule list
                              // (eg execute profile default at .... every...)
...
private:
  ...
  int currentProfileIndex; // holds the current profile index inside the
                           // combobox
