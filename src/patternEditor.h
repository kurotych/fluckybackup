...
//     License luckyBackup is free software: you can redistribute it and/or
...
private slots:
  ...
  void fillPattern(); // SLOT to fill-in the pattern from all the info from the
                      // dialog
  void fileRadioChanged(); // SLOT when the specific file radio button is
                           // toggled
...
private:
  ...
  QString anchorSource; // this holds the final directory of the source when
                        // "backup the entire source directory by name" is used
