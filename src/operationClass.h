...
//==============================================================================================================
// Declaration of operation class (this is the class that holds operation's name
// & arguments)
class operation {
public:
  ...
  QString GetSnapshotsListItem(int itemPosition) const {
    return itsSnapshotsList.value(itemPosition);
  }
  ...
  QString GetExcludeListItem(int itemPosition) const {
    return itsExcludeList.value(itemPosition);
  }
  ...
  QString GetIncludeListItem(int itemPosition) const {
    return itsIncludeList.value(itemPosition);
  }
  ...
  QString GetOptionsListItem(int itemPosition) const {
    return itsOptionsList.value(itemPosition);
  }

  int GetExecuteBeforeListSize() const { return itsExecuteBeforeList.size(); }
  QString GetExecuteBeforeListItem(int itemPosition) const {
    return itsExecuteBeforeList.value(itemPosition);
  }
  bool GetExecuteBeforeListItemState(int itemPosition) const {
    return itsExecuteBeforeListState.value(itemPosition);
  }
  int GetExecuteAfterListSize() const { return itsExecuteAfterList.size(); }
  QString GetExecuteAfterListItem(int itemPosition) const {
    return itsExecuteAfterList.value(itemPosition);
  }
  bool GetExecuteAfterListItemState(int itemPosition) const {
    return itsExecuteAfterListState.value(itemPosition);
  }
  ...
  void SetByPassWARNING(bool ByPassWARNING) {
    itsByPassWARNING = ByPassWARNING;
  }
  ...
  void SetLastExecutionTime(QDateTime lastTime) {
    itsLastExecutionTime = lastTime;
  }
  void SetLastExecutionErrors(int LastExecutionErrors) {
    itsLastExecutionErrors = LastExecutionErrors;
  }

  // snapshots list
  void SetSnapshotsList(QStringList snapslist) { itsSnapshotsList = snapslist; }
  void AddSnapshotsListItem(QString itemText) {
    itsSnapshotsList.append(itemText);
  }
  void ReplaceSnapshotsListItem(int position, QString text) {
    itsSnapshotsList.replace(position, text);
  }
  void RemoveSnapshotsListItem(int position) {
    itsSnapshotsList.removeAt(position);
  }
  ...
  void AppendArg(QString argument) {
    if (argument != "")
      itsArguments.append(argument);
  }
  void InsertDryRunArg() {
    itsArguments.insert(itsArguments.size() - 2, "--dry-run");
  }
  ...
  // Task type
  void SetTypeDirContents(bool TypeDirContents) {
    itsTypeDirContents = TypeDirContents;
  }
  ...
  // Exclude boolean
  void SetExclude() {
    if (((itsExcludeFromFile) && !(itsExcludeFile == "")) || (itsExcludeTemp) ||
        (itsExcludeCache) || (itsExcludeBackup) || (itsExcludeMount) ||
        (itsExcludeLostFound) || (itsExcludeSystem) || (itsExcludeTrash) ||
        (itsExcludeGVFS) || (itsExcludeList.size() > 0))
      itsExclude = true;
    else
      itsExclude = false;
  }
  ...
  void SetExcludeBackup(bool ExcludeBackup) {
    itsExcludeBackup = ExcludeBackup;
  }
  void SetExcludeMount(bool ExcludeMount) { itsExcludeMount = ExcludeMount; }
  void SetExcludeLostFound(bool ExcludeLostFound) {
    itsExcludeLostFound = ExcludeLostFound;
  }
  void SetExcludeSystem(bool ExcludeSystem) {
    itsExcludeSystem = ExcludeSystem;
  }
  ...
  // Exclude from file
  void SetExcludeFromFile(bool ExcludeFromFile) {
    itsExcludeFromFile = ExcludeFromFile;
  }
  ...
  // Include boolean
  void SetInclude() {
    if (((itsIncludeFromFile) && !(itsIncludeFile == "")) ||
  ...
  // Include from file
  void SetIncludeFromFile(bool IncludeFromFile) {
    itsIncludeFromFile = IncludeFromFile;
  }
  // Include mode
  void SetIncludeModeNormal(bool IncludeModeNormal) {
    itsIncludeModeNormal = IncludeModeNormal;
  }
  ...
  void SetRemoteDestination(bool RemoteDestination) {
    itsRemoteDestination = RemoteDestination;
  }
  ...
  void SetRemotePassword(QString RemotePassword) {
    itsRemotePassword = RemotePassword;
  }
  void SetRemoteSSHPassword(QString RemoteSSHPassword) {
    itsRemoteSSHPassword = RemoteSSHPassword;
  }
  void SetRemoteSSHPasswordStr(QString RemoteSSHPassword) {
    itsRemoteSSHPasswordStr = RemoteSSHPassword;
  }
  void SetRemoteSSHOptions(QString RemoteSSHOptions) {
    itsRemoteSSHOptions = RemoteSSHOptions;
  }
  void SetRemoteSSHPort(int RemoteSSHPort) { itsRemoteSSHPort = RemoteSSHPort; }

  // Command options - templates
  void SetOptionsUpdate(bool OptionsUpdate) {
    itsOptionsUpdate = OptionsUpdate;
  }
  void SetOptionsDelete(bool OptionsDelete) {
    itsOptionsDelete = OptionsDelete;
  }
  void SetOptionsRecurse(bool OptionsRecurse) {
    itsOptionsRecurse = OptionsRecurse;
  }
  void SetOptionsOwnership(bool OptionsOwnership) {
    itsOptionsOwnership = OptionsOwnership;
  }
  void SetOptionsSymlinks(bool OptionsSymlinks) {
    itsOptionsSymlinks = OptionsSymlinks;
  }
  void SetOptionsPermissions(bool OptionsPermissions) {
    itsOptionsPermissions = OptionsPermissions;
  }
  void SetOptionsDevices(bool OptionsDevices) {
    itsOptionsDevices = OptionsDevices;
  }
  void SetOptionsCVS(bool OptionsCVS) { itsOptionsCVS = OptionsCVS; }
  void SetOptionsHardLinks(bool OptionsHardLinks) {
    itsOptionsHardLinks = OptionsHardLinks;
  }
  void SetOptionsFATntfs(bool OptionsFATntfs) {
    itsOptionsFATntfs = OptionsFATntfs;
  }
  void SetOptionsSuper(bool OptionsSuper) { itsOptionsSuper = OptionsSuper; }
  void SetOptionsNumericIDs(bool OptionsNumeriIDs) {
    itsOptionsNumericIDs = OptionsNumeriIDs;
  }
  ...
  void AddExecuteBeforeListItem(QString itemText) {
    itsExecuteBeforeList.append(itemText);
  }
  void AddExecuteBeforeListItemState(bool itemState) {
    itsExecuteBeforeListState.append(itemState);
  }
  void AddExecuteAfterListItem(QString itemText) {
    itsExecuteAfterList.append(itemText);
  }
  void AddExecuteAfterListItemState(bool itemState) {
    itsExecuteAfterListState.append(itemState);
  }
