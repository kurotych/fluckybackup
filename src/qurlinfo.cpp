...
QUrlInfo::QUrlInfo(const QString &name, int permissions, const QString &owner,
                   ...
                   bool isDir, bool isFile, bool isSymLink, bool isWritable,
...
bool QUrlInfo::operator==(const QUrlInfo &other) const {
  ...
  return (d->name == other.d->name && d->permissions == other.d->permissions &&
          d->owner == other.d->owner && d->group == other.d->group &&
          d->size == other.d->size &&
          d->lastModified == other.d->lastModified &&
          d->lastRead == other.d->lastRead && d->isDir == other.d->isDir &&
          d->isFile == other.d->isFile && d->isSymLink == other.d->isSymLink &&
