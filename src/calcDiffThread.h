...
public:
  ...
  void
  passParams(QString dirtoreadstring, QString desti,
             QString currentsnapshotdirectory, QString currentsnapshotstring,
             QString sourcelast, QString sourcei, int currentsnapshotno,
             int currentsnaps,
             bool synctype); // set all variables needed for the calculations
...
private:
  QString dirToReadString, dest, CurrentSnapshotDirectory,
