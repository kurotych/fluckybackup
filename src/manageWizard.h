...
//==============================================================================================================
// Declaration of manageWizard class (this is the dialog that launches a
// restore,delete backup wizard)
...
private:
  ...
  QString time;         // holds the execution time of the selected snapshot in
                        // yyyyMMddhhmmss format
  QString timeReadable; // holds the execution time of the selected snapshot in
  ...
  QString outputString; // holds the standard output of the commands to display
                        // at browser
  QString outputError; // holds the standard error of the commands to display at
                       // browser
  ...
  bool MainRun; // becomes true when main rsync is run. False when the specific
                // backed up snapshot files are transfered
  ...
  bool snapSpecificDirExists; // becomes true if the snapshots specific
                              // directory exists
  int count;                  // simple count variable
  int snapToRestore;          // holds the current snapshot that is restored

  void calcCommandArgs(); // function to calculate command arguments for RESTORE
                          // purposes
